...
if(aliengroup.length==0&&gamestate=="play"){
  gamestate="won"
} 
  ...
  text("lifes:"+life,width/2 -600 ,height/2+340)
    ...
    background("black")
    textSize(40)
    text("GAME OVER YOU LOST TRY AGAIN!!",width/2-150,height/2)
  ...
  background("gold")  
  textSize(40)
  text("Victory is ours stay safe ",width/2 -150 , height/2)
  text("U have won with the score of "+score,width/2 - 600,height/2+300)
  }
  }
